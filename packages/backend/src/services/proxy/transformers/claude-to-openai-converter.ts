...
import { 
  ...
  convertOpenAIUsage
} from './utils/claude-to-openai-converters'
...
/**
 * Claude API 到 OpenAI API 的转换器
 * 处理请求转换、响应转换和流式响应转换
 */
class ClaudeToOpenAIConverter implements IConverter<OpenAIRequest, OpenAIResponse> {
  // 流式响应的状态管理
...
export default ClaudeToOpenAIConverter