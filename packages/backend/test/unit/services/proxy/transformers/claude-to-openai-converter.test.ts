/**
 * ClaudeToOpenAIConverter 单元测试
 * 测试 Claude API 到 OpenAI API 的转换逻辑
 */

import { describe, test, expect, beforeEach } from 'vitest'
import ClaudeToOpenAIConverter from '../../../../../src/services/proxy/transformers/claude-to-openai-converter'
import { Anthropic } from '@anthropic-ai/sdk'
import { OpenAI } from 'openai'

describe('ClaudeToOpenAIConverter', () => {
  let converter: ClaudeToOpenAIConverter

  beforeEach(() => {
    converter = new ClaudeToOpenAIConverter()
  })
