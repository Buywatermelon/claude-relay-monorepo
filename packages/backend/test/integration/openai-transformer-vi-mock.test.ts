...
import { OpenAITransformer } from '../../src/services/proxy/transformers/openai-transformer'
...
describe('OpenAITransformer Integration Tests with vi.mock', () => {
  let processor: OpenAITransformer
  let mockCreate: ReturnType<typeof vi.fn>
  
  beforeEach(() => {
    vi.clearAllMocks()
    processor = new OpenAITransformer('test-api-key', 'https://api.openai.com')
